...
public class ShareController implements CommunityConstant {
    ...
    public String share(String htmlUrl) {
        String fileName = CommunityUtil.generateUUID();
         ...
         // fire kafka event about create the image using WK
        Event event = new Event()
                .setTopic(TOPIC_SHARE)
                .setOtherData("htmlUrl", htmlUrl)
                .setOtherData("fileName", fileName)
                .setOtherData("suffix", ".png");
...
//        map.put("shareUrl", domain + contextPath + "/share/image/" + fileName);
    ...
    // get web page image for sharing from local/（deprecated）
    ...
    public void getShareImage(@PathVariable("fileName") String fileName, HttpServletResponse response) {
        ...
        try {
            ...
            logger.error("Can't get the image: " + e.getMessage());
        }
    }
